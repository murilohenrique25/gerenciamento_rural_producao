...
class CadastroMedicamentoSuino extends StatefulWidget {
  final Medicamento medicamento;
  CadastroMedicamentoSuino({this.medicamento});
  @override
  _CadastroMedicamentoSuinoState createState() =>
      _CadastroMedicamentoSuinoState();
}

class _CadastroMedicamentoSuinoState extends State<CadastroMedicamentoSuino> {
