...
import 'package:gerenciamento_rural/helpers/nutricao_concentrado_db.dart';
import 'package:gerenciamento_rural/models/nutricao_concentrado.dart';
import 'package:gerenciamento_rural/screens/screen_animal/bovino/second_screen/tree_screen/cadastro_nutricao_concentrado.dart';
...
class ListNutricaoConcentrado extends StatefulWidget {
  @override
  _ListNutricaoConcentradoState createState() =>
      _ListNutricaoConcentradoState();
}
...
class _ListNutricaoConcentradoState extends State<ListNutricaoConcentrado> {
  ...
  void _showTNPage({NutricaoConcentrado nutricaoConcentrado}) async {
    final recTN = await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CadastroNutricaoConcentrado(
