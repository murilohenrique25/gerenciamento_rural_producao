...
import 'package:gerenciamento_rural/helpers/nutricao_volumoso_db.dart';
import 'package:gerenciamento_rural/models/nutricao_volumoso.dart';
import 'package:gerenciamento_rural/screens/screen_animal/bovino/second_screen/tree_screen/cadastro_nutricao_volumoso.dart';
...
class ListNutricaoVolumoso extends StatefulWidget {
  @override
  _ListNutricaoVolumosoState createState() => _ListNutricaoVolumosoState();
}
...
class _ListNutricaoVolumosoState extends State<ListNutricaoVolumoso> {
  ...
  void _showTNPage({NutricaoVolumoso nutricaoVolumoso}) async {
    final recTN = await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CadastroNutricaoVolumoso(
