...
import 'package:gerenciamento_rural/screens/screen_animal/caprinos/second_screen/tratamentos/tratamento_caprino_list.dart';
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => TratamentoCaprinoList()));
          },
          child: ClipRRect(
