...
import 'package:gerenciamento_rural/screens/screen_animal/caprinos/second_screen/nutricao/screen/second_screen/registers/cadastro_nutricao_concentrado.dart';
...
class ListNutricaoConcentradoCaprino extends StatefulWidget {
  @override
  _ListNutricaoConcentradoCaprinoState createState() =>
      _ListNutricaoConcentradoCaprinoState();
}

class _ListNutricaoConcentradoCaprinoState
    extends State<ListNutricaoConcentradoCaprino> {
  TextEditingController editingController = TextEditingController();
  NutricaoConcentradoEquinoDB helper = NutricaoConcentradoEquinoDB();
  ...
  void _showTNPage({NutricaoConcentrado nutricaoConcentrado}) async {
    final recTN = await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CadastroNutricaoConcentradoCaprino(
