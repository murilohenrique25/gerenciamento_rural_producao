...
class ListNutricaoVolumosoCaprino extends StatefulWidget {
  @override
  _ListNutricaoVolumosoCaprinoState createState() =>
      _ListNutricaoVolumosoCaprinoState();
}

class _ListNutricaoVolumosoCaprinoState
    extends State<ListNutricaoVolumosoCaprino> {
  ...
  void _showTNPage({NutricaoVolumoso nutricaoVolumoso}) async {
    final recTN = await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CadastroNutricaoVolumosoCaprino(
