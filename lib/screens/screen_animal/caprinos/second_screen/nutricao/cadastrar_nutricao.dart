...
class CadastrarNutricaoCaprino extends StatefulWidget {
  @override
  _CadastrarNutricaoCaprinoState createState() =>
      _CadastrarNutricaoCaprinoState();
}

class _CadastrarNutricaoCaprinoState extends State<CadastrarNutricaoCaprino> {
