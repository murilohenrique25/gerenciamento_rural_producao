...
class CadastroMedicamentoCaprino extends StatefulWidget {
  final Medicamento medicamento;
  CadastroMedicamentoCaprino({this.medicamento});
  @override
  _CadastroMedicamentoCaprinoState createState() =>
      _CadastroMedicamentoCaprinoState();
}

class _CadastroMedicamentoCaprinoState
    extends State<CadastroMedicamentoCaprino> {
