...
class CadastroNutricaoSuplementoBovinoCorte extends StatefulWidget {
  final NutricaoSuplementar nutricaoSuplementar;
  CadastroNutricaoSuplementoBovinoCorte({this.nutricaoSuplementar});
  @override
  _CadastroNutricaoSuplementoBovinoCorteState createState() =>
      _CadastroNutricaoSuplementoBovinoCorteState();
}

class _CadastroNutricaoSuplementoBovinoCorteState
    extends State<CadastroNutricaoSuplementoBovinoCorte> {
