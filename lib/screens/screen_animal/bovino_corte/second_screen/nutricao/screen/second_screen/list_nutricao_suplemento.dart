...
class ListNutricaoSuplementoBovinoCorte extends StatefulWidget {
  @override
  _ListNutricaoSuplementoBovinoCorteState createState() =>
      _ListNutricaoSuplementoBovinoCorteState();
}
...
class _ListNutricaoSuplementoBovinoCorteState
  ...
  void _showTNPage({NutricaoSuplementar nutricaoSuplementar}) async {
    final recTN = await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CadastroNutricaoSuplementoBovinoCorte(
