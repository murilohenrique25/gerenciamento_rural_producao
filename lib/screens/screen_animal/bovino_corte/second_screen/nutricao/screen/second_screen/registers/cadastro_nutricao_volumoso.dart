...
class CadastroNutricaoVolumosoBovinoCorte extends StatefulWidget {
  final NutricaoVolumoso nutricaoVolumoso;
  CadastroNutricaoVolumosoBovinoCorte({this.nutricaoVolumoso});
  @override
  _CadastroNutricaoVolumosoBovinoCorteState createState() =>
      _CadastroNutricaoVolumosoBovinoCorteState();
}

class _CadastroNutricaoVolumosoBovinoCorteState
    extends State<CadastroNutricaoVolumosoBovinoCorte> {
