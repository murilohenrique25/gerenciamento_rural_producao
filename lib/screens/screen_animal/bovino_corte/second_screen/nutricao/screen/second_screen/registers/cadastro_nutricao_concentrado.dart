...
class CadastroNutricaoConcentradoBovinoCorte extends StatefulWidget {
  final NutricaoConcentrado nutricaoConcentrado;
  CadastroNutricaoConcentradoBovinoCorte({this.nutricaoConcentrado});
  @override
  _CadastroNutricaoConcentradoBovinoCorteState createState() =>
      _CadastroNutricaoConcentradoBovinoCorteState();
}

class _CadastroNutricaoConcentradoBovinoCorteState
    extends State<CadastroNutricaoConcentradoBovinoCorte> {
