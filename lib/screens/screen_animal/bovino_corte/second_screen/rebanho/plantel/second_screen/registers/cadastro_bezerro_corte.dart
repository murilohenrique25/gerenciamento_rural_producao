...
class CadastroBezerroCorte extends StatefulWidget {
  final BezerroCorte bezerro;

  CadastroBezerroCorte({this.bezerro});
  @override
  _CadastroBezerroCorteState createState() => _CadastroBezerroCorteState();
}
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            _editedBez.nome ?? "Cadastrar Bezerro",
                  ...
                  children: [
                    ...
                    Radio(
                        ...
                        onChanged: (int value) {
                          setState(() {
                            _radioValue = value;
                            _editedBez.situacao = "Morto";
                            if (_editedBez.situacao == "Morto")
                              _showMortoDialog();
                          });
                        }),
                    Text("Morto"),
