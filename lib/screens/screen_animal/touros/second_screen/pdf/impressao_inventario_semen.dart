...
class ImpressaoInventarioSemen extends StatefulWidget {
  final String path;
  ImpressaoInventarioSemen({Key key, this.path}) : super(key: key);

  @override
  _ImpressaoInventarioSemenState createState() =>
      _ImpressaoInventarioSemenState();
}

class _ImpressaoInventarioSemenState extends State<ImpressaoInventarioSemen> {
  PDFDocument _doc;
  bool _loading;
  @override
  void initState() {
