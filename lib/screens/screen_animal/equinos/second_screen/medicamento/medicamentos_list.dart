...
class MedicamentosEquinoList extends StatefulWidget {
  @override
  _MedicamentosEquinoListState createState() => _MedicamentosEquinoListState();
}

class _MedicamentosEquinoListState extends State<MedicamentosEquinoList> {
