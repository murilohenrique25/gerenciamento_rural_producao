...
class ListaCavalos extends StatefulWidget {
  @override
  _ListaCavalosState createState() => _ListaCavalosState();
}

class _ListaCavalosState extends State<ListaCavalos> {
  ...
  void _showTotalCavalosPage({Cavalo cavalo}) async {
    final recCavalo = await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CadastroCavalo(
            cavalo: cavalo,
          ),
        ));
    if (recCavalo != null) {
