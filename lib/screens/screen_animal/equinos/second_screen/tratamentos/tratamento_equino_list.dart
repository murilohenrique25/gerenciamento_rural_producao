...
import 'package:gerenciamento_rural/screens/screen_animal/equinos/second_screen/tratamentos/registers/cadastrar_tratamento_equino.dart';
...
class TratamentoEquinoList extends StatefulWidget {
  @override
  _TratamentoEquinoListState createState() => _TratamentoEquinoListState();
}

class _TratamentoEquinoListState extends State<TratamentoEquinoList> {
  ...
  void _showTratamentoPage({Tratamento tratamento}) async {
    final recTratamento = await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => CadastroTratamentoEquino(
