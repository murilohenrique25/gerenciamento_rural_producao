...
import 'package:gerenciamento_rural/screens/screen_animal/equinos/second_screen/reproducao_screen/estoque_semen_list.dart';
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => ListaEstoqueSemenEquinos()));
          },
          child: ClipRRect(
