...
class CadastroNutricaoSuplementoEquino extends StatefulWidget {
  final NutricaoSuplementar nutricaoSuplementar;
  CadastroNutricaoSuplementoEquino({this.nutricaoSuplementar});
  @override
  _CadastroNutricaoSuplementoEquinoState createState() =>
      _CadastroNutricaoSuplementoEquinoState();
}

class _CadastroNutricaoSuplementoEquinoState
    extends State<CadastroNutricaoSuplementoEquino> {
