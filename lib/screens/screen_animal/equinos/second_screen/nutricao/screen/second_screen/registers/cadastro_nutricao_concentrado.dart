...
class CadastroNutricaoConcentradoEquino extends StatefulWidget {
  final NutricaoConcentrado nutricaoConcentrado;
  CadastroNutricaoConcentradoEquino({this.nutricaoConcentrado});
  @override
  _CadastroNutricaoConcentradoEquinoState createState() =>
      _CadastroNutricaoConcentradoEquinoState();
}

class _CadastroNutricaoConcentradoEquinoState
