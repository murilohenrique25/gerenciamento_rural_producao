...
class CadastroNutricaoVolumosoEquino extends StatefulWidget {
  final NutricaoVolumoso nutricaoVolumoso;
  CadastroNutricaoVolumosoEquino({this.nutricaoVolumoso});
  @override
  _CadastroNutricaoVolumosoEquinoState createState() =>
      _CadastroNutricaoVolumosoEquinoState();
}

class _CadastroNutricaoVolumosoEquinoState
    extends State<CadastroNutricaoVolumosoEquino> {
