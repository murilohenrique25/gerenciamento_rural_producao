...
import 'package:gerenciamento_rural/screens/screen_animal/equinos/second_screen/nutricao/screen/second_screen/registers/cadastro_nutricao_suplemento.dart';
...
class ListNutricaoSuplementoEquino extends StatefulWidget {
  @override
  _ListNutricaoSuplementoEquinoState createState() =>
      _ListNutricaoSuplementoEquinoState();
}

class _ListNutricaoSuplementoEquinoState
    extends State<ListNutricaoSuplementoEquino> {
  ...
  void _showTNPage({NutricaoSuplementar nutricaoSuplementar}) async {
    final recTN = await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CadastroNutricaoSuplementoEquino(
