...
class DescriptionEquinos extends StatefulWidget {
  @override
  _DescriptionEquinosState createState() => _DescriptionEquinosState();
}

class _DescriptionEquinosState extends State<DescriptionEquinos> {
