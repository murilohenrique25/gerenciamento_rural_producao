...
class ImpressaoLote extends StatefulWidget {
  final String path;
  ImpressaoLote({Key key, this.path}) : super(key: key);

  @override
  _ImpressaoLoteState createState() => _ImpressaoLoteState();
}

class _ImpressaoLoteState extends State<ImpressaoLote> {
  PDFDocument _doc;
  bool _loading;
  @override
  void initState() {
