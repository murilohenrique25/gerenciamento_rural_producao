...
class _CadastroLoteState extends State<CadastroLote> {
  ...
  final _codExternoController = TextEditingController();
  ...
  void initState() {
    ...
    if (widget.lote == null) {
      ...
      _codExternoController.text = _editedLote.codigoExterno.toString();
    }
  }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    controller: _codExternoController,
                    decoration: InputDecoration(labelText: "Código Externo"),
                    onChanged: (text) {
                      _loteEdited = true;
                      setState(() {
                        _editedLote.codigoExterno = int.parse(text);
                      });
                    },
