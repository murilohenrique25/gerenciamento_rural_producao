...
class LotesBovinoCorte extends StatefulWidget {
  @override
  _LotesBovinoCorteState createState() => _LotesBovinoCorteState();
}

class _LotesBovinoCorteState extends State<LotesBovinoCorte> {
  TextEditingController editingController = TextEditingController();
  LoteBovinoCorteDB helper = LoteBovinoCorteDB();
  List<Lote> items = [];
  List<Lote> lotes = [];
  List<Lote> tLotes = [];
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Lotes Bovino de Corte"),
      ),
      body: Container(
        child: Column(
          children: [
